...
PEBBLE_SDK_PLATFORM = '/home/aidan/.pebble-sdk/SDKs/current/sdk-core/pebble/diorite'
...
STLIB_MARKER = None
STLIB_ST = '-l%s'
SUPPORTED_PLATFORMS = ['aplite', 'chalk', 'gabbro', 'flint', 'diorite', 'emery', 'basalt']
TARGET_PLATFORMS = ['gabbro', 'flint', 'emery', 'diorite', 'chalk', 'basalt', 'aplite']
TIMESTAMP = 1777160556
USE_GROUPS = True
VERBOSE = 0
